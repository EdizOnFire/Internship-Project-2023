...
import { addOrder } from '../../redux/ordersSlice.ts';
...
const CardComponent = ({ product }: CardComponentProps) => {
    ...
    const onBuy = async () => {
        const order: IProduct = {
            rating: { count: selectValue.current },
            id: product.id,
            title: product.title,
            price: product.price * selectValue.current,
            ...
            <Fade in={true} timeout={1000}>
                <div className='product' role='cell'>
                    <a className='productButton' onClick={() => setShowProductModal(true)}>
                        <img src={product.image || imagePlaceholder} alt='Product-image' />
                    </a>
                        ...
                        <div className='quantityAndImg'>
                            <form>
                                <div className='quantity'>
                                    ...
                                    >
                                        {Array(product.rating?.count).fill(1).map((n, i) => n + i).map((o) => (
